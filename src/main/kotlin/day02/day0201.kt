...
fun checkGames0201(parsed: java.util.ArrayList<Game>, sampleSet: CubeSet): ArrayList<Game>  {
...
fun parseInput(input: List<String>) : ArrayList<Game> {
    val result = arrayListOf<Game>()
