...
//    parsedPageNumbers.forEach { println(it) }
    ...
    parsedPageNumbers.forEach { numbers ->
        ...
        if (correct) correctOrders.add(numbers)
    }
    println("------------------")
    correctOrders.forEach { println(it) }
    correctOrders.map {
...
val sampleOrderingRules = arrayListOf(
    "47|53",
    "97|13",
    "97|61",
    "97|47",
...
val realOrderingRUles = arrayListOf(
    "66|44",
    "14|81",
    "14|63",
    "95|17",
...
val samplePageNumbers = arrayListOf(
    "75,47,61,53,29",
    "97,61,53,29,13",
    "75,29,13",
    "75,97,47,61,53",
...
val realPageNumbers = arrayListOf(
