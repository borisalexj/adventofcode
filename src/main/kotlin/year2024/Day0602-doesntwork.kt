...
//    parsedInput.forEach { println(it) }
    ...
    for (stuckY in 0..parsedInput.size - 1) {
        println("$stuckY - $stuckRoutes")
        for (stuckX in 0..parsedInput[0].size - 1) {
//            println("$stuckY - $stuckX")
...
//                }
                ...
                if (stuckEncounterMap.values.any { it > 3 }) {
