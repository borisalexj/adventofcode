...
////                recursionPushVer(input,posY + moveTo.first,posX + moveTo.second,moveTo.first,moveTo.second, index, displacement = -1)
////            } else if (next == movableL) {
////                recursionPushVer(input, posY + moveTo.first, posX + moveTo.second, moveTo.first, moveTo.second, index) ||
//                recursionPushVer(input,posY + moveTo.first,posX + moveTo.second,moveTo.first,moveTo.second, index, displacement = if (next == movableL) +1 else -1 )
////            } else {
////                throw IllegalStateException()
//            }
//
...
//}
//
//fun recursionPushVer(
//    input: List<MutableList<String>>,
//    posY: Int,
//    posX: Int,
//    moveToY: Int,
//    moveToX: Int,
...
//    if (((current == movableL || current == movableR)&& next == empty && input[posY + moveToY][posX + moveToX + displacement] == empty )
//
//    ) {
//        input[posY + moveToY][posX + moveToX + displacement] = input[posY][posX +displacement]
//        input[posY][posX +displacement] = empty
//        input[posY + moveToY][posX + moveToX] = current
//        input[posY][posX] = empty
//        return true
//    } else if (next == movableL || next == movableR) {
//        if (recursionPushVer(input, posY + moveToY, posX + moveToX, moveToY, moveToX, index, if (next == movableL) +1 else -1 )
//
//        ) {
//            input[posY + moveToY][posX + moveToX + displacement] = input[posY][posX +displacement]
//            input[posY][posX +displacement] = empty
...
////        if (recursionPushVer(input, posY + moveToY, posX + moveToX, moveToY, moveToX, index, 1)
////            && recursionPushVer(input, posY + moveToY, posX + moveToX - 1, moveToY, moveToX, index, 1)
////        ) {
////            if (current == movableL) {
