...
//    val translationMap = arrayListOf<ArrayList<Long>>()
    var lastNumber = Long.MAX_VALUE
    val seedsList = realSeeds
    val updatedSeedList = setOf<Long>()
    for (i in 0..((seedsList.size-1) /2) ) {
        var lastNumber2 = Long.MAX_VALUE
        val _seed = seedsList[i*2].toLong()
        val seedRange = seedsList[i*2+1]
        println("$_seed - $seedRange")
        for (i2 in 0..(seedRange-1)) {
//            updatedSeedList.plus(_seed + i2)
//            lastNumber.add(processSeed(_seed + i2))
            lastNumber2 = min(lastNumber2, processSeed(_seed + i2) )
        }
        println("lastNumber - $lastNumber2")
        lastNumber = min(lastNumber, lastNumber2)
        println("lastNumberMin - $lastNumber")
    }
...
//    println("result - " + translationMap.map { it.last }.min())
    println("result - " + lastNumber)
//    println("result - " + lastNumber2)
    println("processedSeeds - $processedSeeds")
}
// correct answer 2520479
//  100 000 000
//  100 000 000 - 46 50
//  500 000 000 - 230 316
//1 687 205 618
...
fun processSeed(_seed: Long):Long {
    processedSeeds = processedSeeds +1L
//    if (processedSeeds == 1_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
//    if (processedSeeds == 10_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
//    if (processedSeeds == 50_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    if (processedSeeds == 100_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    if (processedSeeds == 500_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    if (processedSeeds == 1_000_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    if (processedSeeds == 2_000_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    if (processedSeeds == 5_000_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    if (processedSeeds == 10_000_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    if (processedSeeds == 20_000_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    if (processedSeeds == 50_000_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    if (processedSeeds == 50_000_000_000L) println(processedSeeds.toString() + " | " + ((System.currentTimeMillis() - start)/1000))
    //    val lastNumber = arrayListOf<Long>()
