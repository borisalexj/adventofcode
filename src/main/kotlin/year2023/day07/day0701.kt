...
//       parsed.sortWith(comparator = comparator)
        parsed.sortedWith(comparator).forEachIndexed{ rank, hand ->
...
object comparator: Comparator<Hand> {
...
//                        else -1)
        if (o1.kind.rank > o2.kind.rank) return 1
            ...
            for (i in 0..5) {
                if (order.indexOf(o1.cards.split("")[i]) > order.indexOf(o2.cards.split("")[i])) return 1
                else if (order.indexOf(o1.cards.split("")[i]) < order.indexOf(o2.cards.split("")[i])) return -1
            }
        }
        println("$o1 - $o2")
 ...
 val order = arrayListOf("A", "K", "Q", "J", "T", "9", "8", "7", "6", "5", "4", "3", "2")
